...
| Trạng thái trong tuần | Đã hoàn tất nền tảng VPC; nhật ký thời gian và một ảnh chụp màn hình liên kết route-table sẽ được hoàn thiện sau |
...
| --- | --- | --- | --- | --- | --- | --- |
| Ngày 1 | 24/05/2026 | Confirm before publishing | Rà soát yêu cầu VPC và lên kế hoạch cho IPv4 CIDR | Dải địa chỉ VPC và các dải subnet đã được định nghĩa | Các dải CIDR cần không được trùng lặp và phải dễ nhận diện | Tạo VPC và các subnets |
| Ngày 2 | 24/05/2026 | Confirm before publishing | Tạo VPC và 4 subnets trải rộng trên 2 Availability Zones | Bố cục mạng public/private đã được thiết lập | Tên của subnet không quyết định tính chất (public/private) của subnet đó | Cấu hình Internet Gateway và bảng định tuyến public (public route table) |
| Ngày 3 | 24/05/2026 | Confirm before publishing | Đính kèm Internet Gateway và cấu hình định tuyến public | Đã xác thực việc định tuyến từ public subnet ra Internet Gateway | Chỉ đính kèm Internet Gateway là chưa đủ, cần phải cấu hình route-table | Rà soát lại việc liên kết route-table (route-table associations) |
| Ngày 4 | 24/05/2026 | Confirm before publishing | Rà soát định tuyến private và ranh giới Security Group | Vùng mạng private đã được tách biệt khỏi định tuyến trực tiếp qua Internet Gateway | Security Groups kiểm soát quyền truy cập lưu lượng nhưng không làm cho một subnet trở thành public hay private | Tiếp tục với bài lab EC2 public/private ở Tuần 3 |
