...
![AWS First Cloud AI Journey Community Day poster](/images/4-EventParticipated/4.2-Event2/poster.png)
...
![Tinh Truong sharing](/images/4-EventParticipated/4.2-Event2/tinh-session.png)
...
![Thinh Nguyen sharing](/images/4-EventParticipated/4.2-Event2/thinh-session.png)
*Thinh Nguyen presenting CloudFront as a foundation from edge to origin.*

![Anh Pham sharing](/images/4-EventParticipated/4.2-Event2/haianh-session.png)
*Anh Pham introducing Friendly AI Assistant with Amazon Quick.*

![Duc Dao sharing](/images/4-EventParticipated/4.2-Event2/duc-session.png)
*Duc Dao explaining the non-determinism of seemingly deterministic LLM settings.*

![Vy Lam sharing](/images/4-EventParticipated/4.2-Event2/vy-session.png)
